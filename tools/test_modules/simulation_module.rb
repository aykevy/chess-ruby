...
module Simulation
    ...
    #Test 16:
    #Insufficient material with two different bishops where one was
    #made from promoting in a different colored tile.
    def simulation_16(board)
        simulate_intro = [
            [[6, 1], [5, 1]], [[6, 2], [5, 2]], [[6, 3], [5, 3]], 
            [[7, 1], [5, 0]], [[7, 2], [6, 1]], [[7, 3], [6, 3]],
            [[1, 3], [3, 3]], [[6, 4], [4, 4]], [[0, 3], [2, 3]],
            ...
            [[6, 0], [6, 4]], [[6, 4], [6, 5]], [[6, 5], [5, 5]],
            [[0, 6], [6, 6]], [[5, 5], [4, 7]], [[4, 7], [5, 7]],
            [[0, 5], [2, 7]], [[6, 6], [6, 7]], [[6, 7], [7, 7]],
            [[7, 7], [5, 7]], [[5, 7], [1, 0]], [[7, 3], [1, 0]],
            [[0, 4], [4, 0]], [[1, 0], [1, 4]], [[1, 4], [1, 0]],
            [[4, 4], [1, 4]]
        ]
        simulate_intro.each do | start, dest = sub_arr |
            board.move_piece(start, dest)
    ...
    #Test 17:
    #Insufficient material with two different bishops where one was
    #made from promoting in the same colored tile.
    def simulation_17(board)
        simulate_intro = [
            [[6, 1], [5, 1]], [[6, 2], [5, 2]], [[6, 3], [5, 3]], 
            [[7, 1], [5, 0]], [[7, 2], [6, 1]], [[7, 3], [6, 3]],
            [[1, 3], [3, 3]], [[6, 4], [4, 4]], [[0, 3], [2, 3]],
    ...
    #Test 18:
    #Same colored bishops at end game should not trigger the insufficient material.
    def simulation_18(board)
        simulate_intro = [
            [[6, 1], [5, 1]], [[6, 2], [5, 2]], [[6, 3], [5, 3]], 
            [[7, 1], [5, 0]], [[7, 2], [6, 1]], [[7, 3], [6, 3]],
            [[1, 3], [3, 3]], [[6, 4], [4, 4]], [[0, 3], [2, 3]],
            ...
            [[0, 6], [6, 6]], [[5, 5], [4, 7]], [[4, 7], [5, 7]],
            [[0, 5], [2, 7]], [[6, 6], [6, 7]], [[6, 7], [7, 7]],
            [[7, 7], [5, 7]], [[5, 7], [1, 0]], [[1, 0], [4, 4]],
            [[1, 4], [4, 4]], [[7, 3], [7, 1]], [[4, 4], [6, 4]]
        ]
        simulate_intro.each do | start, dest = sub_arr |
            board.move_piece(start, dest)
        end
